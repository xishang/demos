...
public class WebUtils {
    ...
    // 静态文件后缀
    private final static String[] staticFiles = StringUtils.split(PropertiesUtils.getValue("web.staticFile"), ",");

    // 动态映射URL后缀
    private final static String URLSUFFIX = PropertiesUtils.getValue("web.urlSuffix");
    ...
    public static boolean isStaticFile(String uri) {
        if (staticFiles == null) {
            LOGGER.warn("检测到“app.properties”中没有配置“web.staticFile”属性。配置示例：\n#静态文件后缀\n"
